...
3. Choose the **Reverse Paycheck** action
...
5. Review the summary amounts:
   ...
   - **Employee Debit** — the total of earnings and employee deductions being reversed. Choose **OK** to process the reversal.
...
2. Choose the **Cancel Reversal** action
