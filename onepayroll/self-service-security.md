...
> [!NOTE]
> The Self-Service Portal does not persist employee or payroll business data of its own; it connects to external data sources and stores only short-lived operational state, such as server-side session data.
