...
The **Employee List** page gives you a centralized view of all employees and their key details, including status, pay group, and employee type.

![Screenshot of the Employee List page showing employee records with status, pay group, and employee type columns.](media/employee-overview/employee-list.png)
...
OnePayroll defines an employee lifecycle through four statuses. The employee cues on the role center help you understand at a quick glance how many employees there are with each status.

![OnePayroll employees cues showing the number of employees in each status.](media/employee-overview/employee-cues.png)
